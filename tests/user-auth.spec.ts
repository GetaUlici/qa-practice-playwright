...
test.describe('User authentication test suite', () => {
  ...
  test('login test - invalid email @regression', async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  test('login test - invalid password @regression', async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  test('Login test - empthy fields', async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  test('Login test - invalid format email', async ({ page }) => {
    const loginPage = new LoginPage(page);
    ...
    expect(message).toContain("Please include an '@'");
  });
